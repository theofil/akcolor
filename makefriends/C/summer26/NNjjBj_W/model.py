...
class JetNN(nn.Module):
    ...
    and the generator-boson pT, η, φ as event-level scalars
    ...
    def __init__(self, dropout=0.3):
        ...
        # 64×3 (pools jet0/1/2) + 3 (jet0) + 3 (jet1) + 4 (jet2) + 3 (boson) = 205
    ...
    def forward(self, x_jet0, x_jet1, x_jet2, x_boson, x_jcs0, x_jcs1, x_jcs2, mask0, mask1, mask2):
        ...
        cat   = torch.cat([pool0, pool1, pool2, x_jet0, x_jet1, x_jet2, x_boson], dim=1)   # (B, 205)
        return self.rho(cat)
