...
class DeepSetsNoFun(nn.Module):
    """
    DeepSets using 4 constituent features only: jcsDEta, jcsDPhi, jcsM, jcsPt.
    jcsW (pull-vector weight) and all jet-level scalars are excluded.
    """
