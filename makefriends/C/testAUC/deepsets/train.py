#!/usr/bin/env python3
"""
Train DeepSetsNoJet: constituent features only, no jet-level scalars.
...
def main():
    ...
    model = DeepSetsNoJet(dropout=DROPOUT).to(device)
    ...
    apply_style(ax, xlabel='Epoch', ylabel='Loss', title='DeepSets (no jet)', legend_loc='upper right')
    plt.tight_layout()
