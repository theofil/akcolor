#!/usr/bin/env python3
"""
Training script for VBF vs QCD dijet classification.
...
def scale_jcs(x_jcs, scaler):
    """Apply scaler to (N, NC_MAX, 5) constituent array."""
    shape = x_jcs.shape
...
def main():
    ...
    x_jet_all = np.concatenate([x_jet_bkg, x_jet_sig], axis=0)   # (N, 6)
    ...
    # compute mask BEFORE scaling — jcsPt (index 3) > 0 identifies real constituents
    mask_train = (x_jcs_all[idx_train][..., 3] > 0)   # (N_train, 80), bool
