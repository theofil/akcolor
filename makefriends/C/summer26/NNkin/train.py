#!/usr/bin/env python3
"""
Training script for VBF Z vs QCD Z+jj classification using kinematic variables only.
...
def main():
    ...
    print(f'  QCD Z+jj Herwig: {len(x_bkg)} events')

    print('Loading signal ...')
    x_sig, _ = load_features(HERE / SIG_FILE)
    print(f'  VBF Z Herwig: {len(x_sig)} events')
