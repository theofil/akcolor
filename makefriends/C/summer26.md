...
condor_submit summer26/NNjZ/train_gpu.sub
condor_submit summer26/NNjj/train_gpu.sub
condor_submit summer26/NNjjZ/train_gpu.sub
```
...
cd summer26/NNjZ   && python train.py
cd summer26/NNjj   && python train.py
cd summer26/NNjjZ  && python train.py
```

The `_H` / `_W` variant directories (generated by `summer26/make_variants.py`)
train the same architectures on the H and W samples. Exception: `NNjZ_H` and
`NNjjZ_H` are excluded from generation and maintained manually — they keep
...
condor_submit summer26/NNjZ/infer_gpu.sub
condor_submit summer26/NNjZ_H/infer_gpu.sub
condor_submit summer26/NNjZ_W/infer_gpu.sub
