...
| **NNZj** | NNj inputs + generator boson `bosonPt, bosonEta, bosonPhi` (`bosonM` only in the `_H` variant) |
...
artifact in the Herwig QCD samples (see `tuesday.md`); for H it is a harmless
constant (125) and was kept. See
