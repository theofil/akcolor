#!/usr/bin/env python3
"""
Training script for NNjj: VBF Z vs QCD Z+jj classification.
...
def main():
    ...
    fig.savefig(FIG_DIR / f'NNjj_{PROCESS}_loss_curve.pdf', bbox_inches='tight')
    plt.close(fig)
    print(f'Saved {FIG_DIR / f"NNjj_{PROCESS}_loss_curve.pdf"}')
