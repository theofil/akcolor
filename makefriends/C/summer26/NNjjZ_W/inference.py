...
def main():
    ...
    print(f'NNjjZ Herwig    AUC = {auc_hw:.4f}')
    print(f'NNjjZ MG5+Py    AUC = {auc_mg5:.4f}')
    ...
    ax.plot(fpr_hw,  tpr_hw,  linewidth=3, color='black',
            label=f'NNjjZ Herwig W  AUC={auc_hw:.3f}')
    ax.plot(fpr_mg5, tpr_mg5, linewidth=3, color='#1f77b4', linestyle='--',
            label=f'NNjjZ MG5+Py W  AUC={auc_mg5:.3f}')
    ...
    out = FIG_DIR / f'roc_nnjjz_{PROCESS}.pdf'
