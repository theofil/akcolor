...
#TOT=10
#JOB=0;SKIP=$((JOB*$TOT)); #./makefriends $ifile  --genWeight evweight --xs 3.601 --skip $SKIP  --totEve $TOT --jobId $JOB
#JOB=1;SKIP=$((JOB*$TOT)); #./makefriends $ifile  --genWeight evweight --xs 3.601 --skip $SKIP  --totEve $TOT --jobId $JOB
