#!/usr/bin/env python3
"""
Inference script for NNPrePro (summer26, Herwig Z): ROC curves comparing performance
...
Output:
  ../../figs/summer26/roc_nnprepro.pdf
"""
...
def main():
    ...
    print(f'NNPrePro Herwig    AUC = {auc_hw:.4f}')
    print(f'NNPrePro MG5+Py    AUC = {auc_mg5:.4f}')
    ...
    ax.plot(fpr_hw,  tpr_hw,  linewidth=3, color='black',
            label=f'NNPrePro Herwig W  AUC={auc_hw:.3f}')
    ax.plot(fpr_mg5, tpr_mg5, linewidth=3, color='#1f77b4', linestyle='--',
            label=f'NNPrePro MG5+Py Z  AUC={auc_mg5:.3f}')
    ...
    out = FIG_DIR / f'roc_nnprepro_{PROCESS}.pdf'
