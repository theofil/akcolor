#!/usr/bin/env python3
"""
Training script for VBF vs QCD dijet classification — Transformer model.

Outputs saved to NNtrans/ (directory of this script):
...
def main():
    ...
    model = TransJetNN(dropout=DROPOUT, clf_dropout=CLF_DROP).to(device)
