...
def main():
    ...
    fig.savefig(FIG_DIR / f'NNRaw_{PROCESS}_loss_curve.pdf', bbox_inches='tight')
    plt.close(fig)
    print(f'Saved {FIG_DIR / f"NNRaw_{PROCESS}_loss_curve.pdf"}')
