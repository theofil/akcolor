#!/usr/bin/env python3
"""
Training script for NNjjB: VBF Z vs QCD Z+jj classification.
...
Outputs saved to NNjjB/ (directory of this script):
...
def main():
    ...
    fig.savefig(FIG_DIR / f'NNjjB_{PROCESS}_loss_curve.pdf', bbox_inches='tight')
    plt.close(fig)
    print(f'Saved {FIG_DIR / f"NNjjB_{PROCESS}_loss_curve.pdf"}')
