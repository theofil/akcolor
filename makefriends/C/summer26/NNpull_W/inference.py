#!/usr/bin/env python3
"""
Inference script for NNpull (summer26, Herwig Z): ROC curves comparing performance
...
BKG_FILE_MG5 = '../../friends/summer26/QCDWjj_mg5_pythia.h5'
SIG_FILE_MG5 = '../../friends/summer26/VBFW_mg5_pythia.h5'
...
# JET_FEATURES order: |jetEta|, jetM, jetPVM, jetPt, jetSPVA
...
def main():
    ...
    print(f'NNpull Herwig    AUC = {auc_hw:.4f}')
    print(f'NNpull MG5+Py    AUC = {auc_mg5:.4f}')
    ...
    ax.plot(fpr_hw,  tpr_hw,  linewidth=3, color='black',
            label=f'NNpull Herwig W  AUC={auc_hw:.3f}')
    ax.plot(fpr_mg5, tpr_mg5, linewidth=3, color='#1f77b4', linestyle='--',
            label=f'NNpull MG5+Py Z  AUC={auc_mg5:.3f}')
    ...
    out = FIG_DIR / f'roc_nnpull_{PROCESS}.pdf'
