"""
DijetDataset for NNjjBj: loads QCDWjj_herwig.h5 + VBFW_herwig.h5.
Identical inputs to NNjjB (both leading jets, raw low-level features, plus the
generator-boson pT, η, φ as event-level scalars) extended with the 3rd
...
def load_features(h5path):
    """Return x_jet0 (N,3), x_jet1 (N,3), x_jet2 (N,4), x_boson (N,3),
