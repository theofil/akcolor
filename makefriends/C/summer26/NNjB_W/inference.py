#!/usr/bin/env python3
"""
Inference script for NNjB (summer26, Herwig Z): ROC curves comparing performance
...
def main():
    ...
    print(f'NNjB Herwig    AUC = {auc_hw:.4f}')
    print(f'NNjB MG5+Py    AUC = {auc_mg5:.4f}')
    ...
    ax.plot(fpr_hw,  tpr_hw,  linewidth=3, color='black',
            label=f'NNjB Herwig W  AUC={auc_hw:.3f}')
    ax.plot(fpr_mg5, tpr_mg5, linewidth=3, color='#1f77b4', linestyle='--',
            label=f'NNjB MG5+Py W  AUC={auc_mg5:.3f}')
    ...
    out = FIG_DIR / f'roc_nnjb_{PROCESS}.pdf'
