#!/usr/bin/env python3
"""
Inference for TransNoJet: ROC curve on held-out test set.

Outputs (next to this script):
  scores.npz           — y_test, nn_scores  (read by compare_roc.py)
  roc_trans_nojet.pdf  — ROC vs individual jet variables
"""
...
def main():
    ...
    print(f'Transformer (no jet) test AUC = {auc_nn:.4f}')
    ...
    ax.plot(fpr_nn, tpr_nn, linewidth=3, color='black',
            label=f'Transformer (no jet)  AUC={auc_nn:.3f}')
