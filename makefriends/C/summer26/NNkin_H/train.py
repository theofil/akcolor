#!/usr/bin/env python3
"""
Training script for VBF H vs QCD H+jj classification using kinematic variables only.
...
def main():
    ...
    print(f'  QCD H+jj Herwig: {len(x_bkg)} events')

    print('Loading signal ...')
    x_sig, _ = load_features(HERE / SIG_FILE)
    print(f'  VBF H Herwig: {len(x_sig)} events')
