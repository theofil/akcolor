"""
DijetDataset for NNjjB: loads QCDWjj_herwig.h5 + VBFW_herwig.h5.
...
def load_features(h5path):
    ...
    return x_jet0, x_jet1, x_bos, x_jcs0, x_jcs1, kw


class DijetDataset(Dataset):
    def __init__(self, x_jet0, x_jet1, x_boson, x_jcs0, x_jcs1, mask0, mask1, y, w=None):
    ...
    def __getitem__(self, idx):
        return (self.x_jet0[idx], self.x_jet1[idx], self.x_boson[idx],
